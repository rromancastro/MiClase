        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={{flexDirection: 'row', gap: 20, marginVertical: 10}}>
                    <TouchableOpacity onPress={()=>setPregunta({...pregunta, respuestaCorrecta: 1})}><Text style={{...styles.buttonCorrecta, backgroundColor: pregunta.respuestaCorrecta === 1 ? '#2EB38D' : '#EF494D'}}>1</Text></TouchableOpacity>
                    <TouchableOpacity onPress={()=>setPregunta({...pregunta, respuestaCorrecta: 2})}><Text style={{...styles.buttonCorrecta, backgroundColor: pregunta.respuestaCorrecta === 2 ? '#2EB38D' : '#EF494D'}}>2</Text></TouchableOpacity>
                    <TouchableOpacity onPress={()=>setPregunta({...pregunta, respuestaCorrecta: 3})}><Text style={{...styles.buttonCorrecta, backgroundColor: pregunta.respuestaCorrecta === 3 ? '#2EB38D' : '#EF494D'}}>3</Text></TouchableOpacity>
                    <TouchableOpacity onPress={()=>setPregunta({...pregunta, respuestaCorrecta: 4})}><Text style={{...styles.buttonCorrecta, backgroundColor: pregunta.respuestaCorrecta === 4 ? '#2EB38D' : '#EF494D'}}>4</Text></TouchableOpacity>
                </View>
